...
test_that("fetch_lords processes results correctly.", {
    with_mock(
        fetch_lords_raw = mock_fetch_lords_raw,
        fetch_lords_memberships = mock_fetch_lords_memberships_raw, {
...
test_that("fetch_lords_memberships processes results correctly.", {
    with_mock(
        fetch_lords_memberships_raw = mock_fetch_lords_memberships_raw, {
...
test_that("fetch_lords_party_memberships processes results correctly.", {
    with_mock(fetch_lords_party_memberships_raw =
...
test_that("fetch_lords_government_roles processes results correctly.", {
    with_mock(
        fetch_lords_government_roles_raw = mock_fetch_lords_government_roles_raw, {
...
test_that("fetch_lords_opposition_roles processes results correctly.", {
    with_mock(
        fetch_lords_opposition_roles_raw = mock_fetch_lords_opposition_roles_raw, {
...
test_that("fetch_lords_committee_memberships processes results correctly.", {
    with_mock(
        fetch_lords_committee_memberships_raw =
